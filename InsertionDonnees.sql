...
INSERT INTO Monstre (id_monstre, nom, code_employe, point_vie, attaque, numero_ass_maladie, id_famille, experience) VALUES
	...
	(4, 'Morgoth', 'M007', 36, 8, crypter('MORG 8923 6524'), 2, 15),
	(5, 'Syra', 'S024', 42, 6, crypter('SYRA 9791 7455'), 4, 18),
	(6, 'Néphérite', 'N888', 86, 9, crypter('NÉPH 9879 6949'), 5, 120),
	(7, 'Garry', 'G420', 7, 2, crypter('GARR 2687 2815'), 9, 5),
	(8, 'Jerry', 'J420', 7, 2, crypter('JERR 9428 2918'), 9, 5),
	(9, 'Terry', 'T420', 7, 2, crypter('TERR 7754 8029'), 9, 5),
	(10, 'Larry', 'L420', 7, 2, crypter('LARR 3540 8390'), 9, 5),
	(11, 'Molustus', 'M666', 55, 12, crypter('MOLU 5965 1164'), 8, 25),
	(12, 'Combustus', 'C457', 55, 12, crypter('COMB 1235 5017'), 8, 34),
	(13, 'Aero', 'A875', 29, 9, crypter('AERO 6682 1603'), 6, 19),
	(14, 'Miro', 'M442', 29, 9, crypter('MIRO 8066 2007'), 6, 0),
	(15, 'Nefustus', 'N410', 37, 6, crypter('NEFU 9123 3159'), 7, 12),
	(16, 'Albertus', 'A002', 37, 6, crypter('ALBE 4055 3115'), 7, 4),
	(17, 'Clyde', 'C876', 15, 4, crypter('CLYD 4232 5481'), 10, 3),
	(18, 'Bonnie', 'B452', 15, 4, crypter('BONN 9211 5333'), 10, 8),
	(19, 'Korg', 'K374', 12, 4, crypter('KORG 9518 8644'), 11, 5),
	(20, 'Buld', 'B350', 12, 4, crypter('BULD 6936 3187'), 11, 7),
	(21, 'Norm', 'N583', 12, 4, crypter('NORM 5410 5440'), 11, 9),
	(22, 'Ywan', 'Y690', 12, 4, crypter('YWAN 6347 6248'), 11, 15),
	(23, 'Molg', 'M256', 12, 4, crypter('MOLG 2696 5245'), 11, 2),
	(24, 'Euld', 'E248', 12, 4, crypter('EULD 7169 3555'), 11, 0),
	(25, 'Bizomo', 'B754', 6, 2, crypter('BIZO 3762 7149'), 12, 0),
	(26, 'Kallioko', 'K475', 6, 2, crypter('KALL 8143 5343'), 12, 3),
	(27, 'Ariama', 'A320', 6, 2, crypter('ZORI 2256 9932'), 12, 2),
	(28, 'Burt', 'B867', 36, 8, crypter('BURT 7912 6165'), 2, 21),
